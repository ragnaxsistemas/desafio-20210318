...
CREATE TABLE `feriado` (
  ...
  `fecha_feriado` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `indicador` (
  ...
  `codigo_indicador` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
-- Dump completed on 2021-03-19  1:22:47
